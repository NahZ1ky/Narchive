...
public class Tiger extends Mammal
{
    ...
    private int extraExercise;

    //-----------------------------------------------------------------
    //  Constructor: Sets up this tiger with the specified information.
    //-----------------------------------------------------------------
    public Tiger(int eTagID, String eSpecies, String eName, double feedLB, int extraExercise)
    {
    ...
    public int activityHours() {
        return STANDARD_ACTIVITY_HOURS + extraExercise;
    }
}