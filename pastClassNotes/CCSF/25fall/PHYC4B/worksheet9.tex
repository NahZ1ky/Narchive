...
\begin{figure}[htbp]
\centering
\includegraphics[height=3cm]{./img/9.1.jpg}
\caption{\label{fig:orgd4a020a}Multi-loop circuit with three batteries and two external resistors}
\end{figure}
\begin{enumerate}
\item Determine the current (including direction) in each branch of the circuit above.
...
\item What would be the direction of the current in the middle branch (up or down) if the \(3.0 \Omega\) resistor in the left branch were replaced by a \(4.0 \Omega\) resistor?  Do not attempt to solve the new circuit, but explain your reasoning.
\end{enumerate}
\end{enumerate}
